...
static PyMethodDef _cffi_methods[] = {
  {"_cffi_layout_struct_rsa_meth_st", _cffi_layout_struct_rsa_meth_st, METH_NOARGS, NULL},
  {"_cffi_layout_struct_rsa_st", _cffi_layout_struct_rsa_st, METH_NOARGS, NULL},
...
PyMODINIT_FUNC
PyInit__cffi__x88a8fd90x94e38fe2(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x88a8fd90x94e38fe2(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x88a8fd90x94e38fe2", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
